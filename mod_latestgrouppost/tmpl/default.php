...
?>
	...
	<li>
		<div style="float: left;">
			<a title="<?php echo $user->name?>" href="<?php echo CRoute::_('index.php?option=com_community&view=profile&userid='.$user->id); ?>">
		...
		<div style="margin-left: 42px; line-height: normal;">
			...
			<span style="width: 100%;"><?php echo JText::sprintf('MOD_LATESTGROUPPOST_BY', '<a href="'.CRoute::_('index.php?option=com_community&view=profile&userid='.$user->id).'">'.$user->name.'</a>'); ?></span>
